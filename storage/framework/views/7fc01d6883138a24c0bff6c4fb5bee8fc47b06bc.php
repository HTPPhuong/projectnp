    ...
    <div class="collapse navbar-collapse" id="bdNavbar">
      <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
        <li class="nav-item col-6 col-md-auto">
          <a class="nav-link p-2" href="<?php echo e(url('/book')); ?>" >Sach</a>
        </li>
        <li class="nav-item col-6 col-md-auto">
          <a class="nav-link p-2" href="<?php echo e(url('/reader')); ?>" >Doc gia</a>
          
        </li>
        <li class="nav-item col-6 col-md-auto">
          <a class="nav-link p-2" href="<?php echo e(url('/reader')); ?>" >Thong tin muon sach</a>
        </li>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\project2\resources\views/library/home.blade.php ENDPATH**/ ?>